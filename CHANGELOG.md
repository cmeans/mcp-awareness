...
- OAuth proxy rate limits now configurable via `AWARENESS_OAUTH_PROXY_RATE_{AUTHORIZE,TOKEN,REGISTER}` (defaults raised from 20/10/5 to 60/60/30 req/min)
...
[Unreleased]: https://github.com/cmeans/mcp-awareness/compare/v0.16.0...HEAD
