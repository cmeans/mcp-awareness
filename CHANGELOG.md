...
### Changed
- **Bump github-actions group: codecov/codecov-action 6.0.0→6.0.1, actions/create-github-app-token 3.1.1→3.2.0, docker/setup-buildx-action 4.0.0→4.1.0, docker/login-action 4.1.0→4.2.0, docker/build-push-action 7.1.0→7.2.0, gitleaks/gitleaks-action 2.3.9→3.0.0** (#415)
