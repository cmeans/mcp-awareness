...
echo ""
echo "  Your AI may also have stored memories in its own client (Claude Memory,"
echo "  .agent.md files, etc). Check your client's memory/settings to clean those up."
echo ""
