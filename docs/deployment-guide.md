...
This will:
  1. Download a Docker Compose file
  2. Start three containers (Awareness server, Postgres, Cloudflare tunnel)
  3. Give you a public URL to connect from any MCP client
...
✓ Docker Compose v2 is available (5.0.2)
✓ Internet connectivity looks good

✓ All checks passed!

Install location? [/home/you/mcp-awareness-demo]:
✓ Install directory: /home/you/mcp-awareness-demo
→ Downloading docker-compose-demo.yaml...
✓ Downloaded compose file

→ Starting services...
  This pulls three Docker images on first run — it may take a minute or two.

 ✔ Container mcp-awareness-demo-postgres    Healthy
 ✔ Container mcp-awareness-demo             Healthy
 ✔ Container mcp-awareness-demo-tunnel      Created

✓ Services are starting

→ Waiting for the tunnel URL (this usually takes 10–15 seconds)...

─────────────────────────────────────────────────────────────────
mcp-awareness is running!
─────────────────────────────────────────────────────────────────

Your MCP URL: https://example-words-here.trycloudflare.com/mcp

! This URL is temporary — it changes every time you restart.

Connect your AI:

Claude.ai (Settings → Connectors → Add custom connector):
  Name: awareness
  URL:  https://example-words-here.trycloudflare.com/mcp
...
Getting started:
  ...
  Your instance is pre-loaded with demo data. Start a conversation
  and your AI will discover it automatically via the briefing.

  If your client supports prompts, try the "getting-started" prompt
  to personalize your instance — your AI will interview you and
  store what it learns.

! Best experience with Claude Sonnet 4.6 or Opus 4.6.
  Smaller models (Haiku, GPT-4o-mini) may not follow MCP prompts reliably.

─────────────────────────────────────────────────────────────────
Managing your installation:

  Compose file: /home/you/mcp-awareness-demo/docker-compose-demo.yaml

  View logs:    docker compose -f /home/you/mcp-awareness-demo/docker-compose-demo.yaml logs -f
  Stop:         docker compose -f /home/you/mcp-awareness-demo/docker-compose-demo.yaml down
  Restart:      docker compose -f /home/you/mcp-awareness-demo/docker-compose-demo.yaml up -d
                (you'll get a new tunnel URL — check logs for it)

  Remove everything (including your data):
    docker compose -f /home/you/mcp-awareness-demo/docker-compose-demo.yaml down -v

  Your AI may also have stored memories in its own client (Claude Memory,
  .agent.md files, etc). Check your client's memory/settings to clean those up.
```
